...
class SerialGUI:
    def __init__(self, root: tk.Tk):
        ...
        try:
            _icon_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "KestrelSAT_logo.png")
    ...
    def create_status_bar(self):
        ...
        self.plot_status_label = ttk.Label(self.status_bar, text="Click 'Show Plot Window' to display real-time plots")
    ...
    def update_port_list(self):
        ...
        # Sort ports so the highest COM number is first
        def _port_key(p):
            m = re.search(r'(\d+)$', p)
...
For technical support, refer to the README.md file."""
    ...
    def create_plot_content(self):
        ...
        # Button bar - packed BOTTOM first so it's always visible regardless
        ...
        # Center buttons inside the bar using an inner frame
    ...
    def show_plot_window(self):
        ...
        try:
            if self.plot_window is None:
                ...
                # Position the plot window immediately to the right of the main window
                main_x = self.root.winfo_x()
                main_y = self.root.winfo_y()
                main_w = self.root.winfo_width()
                main_h = self.root.winfo_height()
                self.plot_window.setGeometry(main_x + main_w + 4, main_y, 800, main_h)
    ...
    def clear_plot_data(self):
        ...
        # Scroll back to the top now that the list is empty
